...
class ThreeDAnnotationHero extends StatelessWidget {
  ...
  Widget _buildDesktopCapabilities(BuildContext context) {
    return Row(
      ...
      children: [
        _buildCapabilityItem(context, Icons.view_in_ar, '3D Bounding Boxes', 0),
        _buildCapabilityItem(context, Icons.scatter_plot, 'Point Cloud Segmentation', 200),
        _buildCapabilityItem(context, Icons.radar, 'LiDAR Processing', 400),
        _buildCapabilityItem(context, Icons.precision_manufacturing, 'Spatial Analysis', 600),
      ],
    );
  }
    ...
    return Column(
      children: [
        Row(
          ...
          children: [
            _buildCapabilityItem(context, Icons.view_in_ar, '3D Bounding Boxes', 0),
            _buildCapabilityItem(context, Icons.scatter_plot, 'Point Segmentation', 200),
          ],
        ),
  ...
  Widget _buildCapabilityItem(BuildContext context, IconData icon, String label, int delay) {
    return Container(
      width: ResponsiveBreakpoints.of(context).largerThan(TABLET) ? null : 150,
